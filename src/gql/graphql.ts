...
export type PopularPosts_Query3QueryVariables = Exact<{ [key: string]: never; }>;


export type PopularPosts_Query3Query = { __typename?: 'Query', popularPosts: Array<(
